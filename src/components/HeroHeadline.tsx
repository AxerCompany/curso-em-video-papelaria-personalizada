...
import { Volume2, Sparkles, Check, ArrowDown } from 'lucide-react';
  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-[#5B2A86] to-[#7B3DB8] text-white pt-6 pb-16 px-4 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* Mini VSL no Formato Mobile (Vertical 9:16) */}
        <div className="relative max-w-4xl mx-auto mt-2">
          {/* Alerta de Áudio / Atenção */}
          <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-pink-200 bg-pink-950/60 border border-pink-500/40 px-4 py-1.5 rounded-full mb-5 w-fit mx-auto shadow-md backdrop-blur-sm">
            <Volume2 className="w-4 h-4 text-[#F472B6] animate-pulse shrink-0" />
            <span>Assista ao vídeo rápido abaixo antes de acessar seus moldes</span>
          </div>

          {/* Moldura de Smartphone / Player Mobile Vertical 9:16 */}
          <div className="relative max-w-[320px] sm:max-w-[360px] md:max-w-[380px] mx-auto group">
            {/* Brilho e Luz Ambiente Traseira */}
            <div className="absolute -inset-2 bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 rounded-[2.5rem] blur-xl opacity-60 group-hover:opacity-80 transition duration-500 pointer-events-none" />

            <div className="relative rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.65)] border-4 border-pink-400/40 bg-black aspect-[9/16]">
              <iframe
                src="https://player.vimeo.com/video/1229707590?badge=0&autopause=0&player_id=0&app_id=58479"
                className="absolute inset-0 w-full h-full"
                frameBorder="0"
                allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"
                allowFullScreen
                title="Mini VSL - Curso em Vídeo de Papelaria Personalizada"
              />
            </div>
          </div>

          {/* Key Value Micro-Points under Video */}
